...
<script>
 	...
 	function changeMenuItemImg() {
 		if($('.user-management-menu img').attr('src').includes('black') && !$('.user-management-menu').css('border-color').includes('rgb(86, 34, 173)')) {
...
<div id="section">
  ...
  <div id="side-menubar">
    <div id="side-menubar-logo">
      <a href="/admin/manager_index" class="">
      ...
      <ul class="menu-list">
        <li class="menu-item-1 user-management-menu">
          <div class="menu-item-group-1">
            <div class="menu-item-1-div">
              ...
              <a href="javascript:void(0)" class="menu-item-text-1">유저관리</a>
            </div>
            <script>
              $(function() {
        ...
        <li class="menu-item-2 faq-management-menu">
          <div class="menu-item-group-2">
            ...
            <a href="/admin/admin_faqList" class="menu-item-text">FAQ</a>
          </div>
        </li>
        ...
        <li class="menu-item-1 user-management-menu">
          <div class="menu-item-group-1">
            <div class="menu-item-1-div">
              ...
              <a href="javascript:void(0)" class="menu-item-text-1-mobile">유저관리</a>
            </div>
            <script>
              $(function() {
