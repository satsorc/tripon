...
<%@ include file="./template/header.jsp" %>
	...
	<form action="/loginIndex" method="post" class="needs-validation" novalidate>
		<div class="login_id">
			<input type="text" id="uid" class="form-control" name="mem_id" placeholder="아이디" required>
			<div class="invalid-feedback">아이디를 입력해주세요</div>
		</div>
		
		<div class="login_pw">
			<input type="password" id="upw" class="form-control" name="mem_pw" placeholder="비밀번호(8~15자리 숫자, 영문자, 특수문자)" required>
		...
		<c:if test="${error ne null}">
		 ...
		 <div class="social-icons">  	
			...
			<!-- ▼ 네이버 로그인  API -->
			<a href="#"><img class="naver" src="${pageContext.request.contextPath}/resources/imgs/naver.png" width="50" /></a>
		 </div>
