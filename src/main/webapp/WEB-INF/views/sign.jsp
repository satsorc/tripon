...
<div class="sign">
	...
	<form name="frm" novalidate>
		...
		<div class="row">
			<label class="cd check-label valid-check col-6" for="agree1">
				<input type="checkbox" class="agree" name="agree" id="agree1">
				<span class="ct">&nbsp;&nbsp;개인정보 이용 동의 (필수)</span>
			</label>
			
			<label class="check-label col-6" for="agree2">
		...
		<div class="phonenumber sign-inner-div" style="display: flex;">
			<label class="la col-3" for="phone">휴대폰 번호</label>
		...
		<div class="number sign-inner-div" style="display: flex;">
			<label class="la col-3" for="num">인증번호</label>
			<div class="col-9 inner-div-col row">
				<input type="text" class="valid-check col-3" id="num" >	
				<span class="point successPhoneChk col-9">* 인증번호를 입력해주세요.</span>
			</div>	
		...
		<div class="submit">
			...
			<input type="button" value="취소" onclick="history.go(-1);" style="background-color: #000000;">
