...
<h2>아이디 찾기</h2>
<br><br>
<h1>등록된 회원정보로 </h1><h1>아이디를 찾으실 수 있습니다.</h1>
<br><br>
	<form action="/findID2" method="post" onsubmit="return checkForm();">
		...
		<div class="information">
			...
			<div class="name find-inner-div" style="display: flex;">
			<label for="name1" class="col-3 inner-div-col">이름</label>
			<div class="col-9 inner-div-col">
				<input type="text" class="find-inner-input" name="mem_username" id="name1" placeholder="한글 또는 영문으로 입력해주세요.">
			</div>
			</div>
			
			<div class="phonenumber find-inner-div" style="display:flex">
				<label for="phone" class="col-3 inner-div-col">휴대폰 번호</label>
				<div class="col-9 inner-div-col">
		...
		<div class="information">
			...
			<div class="col-9 inner-div-col">
				<input type="text" class="find-inner-input" name="mem_username" id="name2" placeholder="한글 또는 영문으로 입력해주세요." >
			</div>
			</div>
			<div class="email find-inner-div" style="display: flex;">
			<label for="email" class="col-3 inner-div-col">이메일주소</label>
			<div class="col-9 inner-div-col">
				<input type="text" class="find-inner-input" name="mem_email" id="email" placeholder="이메일 주소를 입력해주세요.">
			</div>
			</div>
		</div>
		...
		<div class="submit">
			...
			<input type="button" value="취소" onClick="self.location='login';" style="background-color: #000000;">
