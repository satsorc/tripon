...
<div class="adminInsert">
	...
	<div class="id insert-inner-div" style="display: flex;">
		<label for="userid" class="col-3 inner-div-col"><span>* </span>아이디</label>
		<div style="display: flex" class="col-9 inner-div-col">
			<input type="text" class="valid-check insert-inner-input" name="mem_id" id="userid" placeholder="아이디를 입력해주세요.">
	...
	<div class="pw insert-inner-div" style="display: flex;">
		<label for="userpw"  class="col-3 inner-div-col"><span>* </span>비밀번호</label>
		<div class="col-9 inner-div-col">
			<input type="password" class="valid-check insert-inner-input" name="mem_pw" id="userpw" placeholder="비밀번호를 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="name insert-inner-div" style="display: flex;">
		<label for="username" class="col-3 inner-div-col"><span>* </span>이름</label>
		<div class="col-9 inner-div-col">
			<input type="text" class="valid-check insert-inner-input" name="mem_username" id="username" placeholder="이름을 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="nickname insert-inner-div" style="display: flex;">
		<label for="usernickname" class="col-3 inner-div-col"><span>* </span>닉네임</label>
		<div class="col-9 inner-div-col">
			<input type="text" class="valid-check insert-inner-input" name="mem_nickname" id="usernickname" placeholder="닉네임을 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="phonenumber insert-inner-div" style="display:flex">
	...
	<div class="email insert-inner-div" style="display: flex;">
		<label for="useremail" class="col-3 inner-div-col"><span>* </span>이메일주소</label>
		<div class="col-9 inner-div-col">
			<input type="email" class="valid-check insert-inner-input" name="mem_email" id="useremail" placeholder="이메일주소를 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="permission insert-inner-div" style="display: flex;">
	...
	<div class="address insert-inner-div" style="display: flex;">	
