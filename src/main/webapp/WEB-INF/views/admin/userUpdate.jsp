...
<div class="userUpdate">
	...
	<form action="/admin/userUpdate" class="needs-validation" novalidate method="POST">
	...
	<div class="id update-inner-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<h3>${userOne.mem_id}<input type="hidden" name="mem_id" value="${userOne.mem_id}"></h3>
		</div>	
	</div>
	...
	<div class="pw update-inner-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="password" class="valid-check update-inner-input" name="mem_pw" id="userpw" value="${userOne.mem_pw}">
	...
	<div class="name update-inner-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="text" class="valid-check update-inner-input" name="mem_username" id="username" value="${userOne.mem_username}">
		</div>
	</div>
	...
	<div class="nickname update-inner-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="text" class="valid-check update-inner-input" name="mem_nickname" id="usernickname" placeholder="닉네임" value="${userOne.mem_nickname}">
		</div>
	</div>
		...
		<div class="col-9 inner-div-col" style="margin-top: 10px;">
			<div class="row phone-group">	
				<div class="col-4 inner-div-col">
					<select name="mem_phone_01" id="phone" class="select-valid-check" value="${fn:substring(userOne.mem_phone,0,3) }">
				...
				<div class="col-4 inner-div-col phone-group-input">
					<div>&nbsp;-&nbsp;</div>
					<input type="tel" name="mem_phone_02" value="${fn:substring(userOne.mem_phone,3,7) }" class="valid-check" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
				</div>
				<div class="col-4 inner-div-col phone-group-input">
					<div>&nbsp;-&nbsp;</div>
					<input type="tel" name="mem_phone_03" value="${fn:substring(userOne.mem_phone,7,11) }" class="valid-check" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
				</div>
			</div>		
		</div>	
	</div>        
	...
	<div class="email update-inner-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="email" class="valid-check update-inner-input" name="mem_email" id="useremail" value="${userOne.mem_email}">
		</div>
	</div>
	...
	<div class="address update-inner-div" style="display: flex;">	
	    ...
	    <div class="col-9 inner-div-col" style="width : 500px;">
			<div>
				...
				<input type="text" name="mem_address_01" id="sample6_postcode" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[0]}</c:if>" placeholder="우편번호" style="margin-left: 5px; width: 120px;">
			</div>
			<div>
				<input type="text" class="col-12" name="mem_address_02" id="sample6_address" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[1]}</c:if>" placeholder="우편번호주소">
				<input type="text" class="col-12" name="mem_address_03" id="sample6_detailAddress" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[2]}</c:if>" placeholder="상세주소">
			</div>
	    </div>
	</div>
	...
	<div class="submit">
		<a href="userList"><input type="button" value="목록" style="background-color: #000000; margin-right: 5px;"></a>
