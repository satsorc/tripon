...
<div class="container" id="searchcontainer">
    <form action="/admin/admin_getActivityList" method="post">
        <div class="input-group col-mb-3">
            ...
            <input type="text" class="form-control" name="searchkeyword" placeholder="search here" aria-label="Recipient's username" aria-describedby="button-addon2">
...
<div class="container" id="admin_activityList">
    ...
    <div class="row justify-content-md-center" id="table_footer">
        ...
        <div class="insert_btn">
            <a href="admin_insertActivity" class="btn btn-primary pull-right">상품등록</a>
        </div>
    </div>
</div>
<!-- Section End-->
